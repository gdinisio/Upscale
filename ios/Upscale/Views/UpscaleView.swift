...
private extension UpscaleView {
    ...
    var selectedAIPipelineLabel: String {
        ...
        case .balanced:
            return "Pipeline: BSRGAN restoration -> MMRealSRGAN upscale (multi-view inference)"
        case .ultra:
            return "Pipeline: BSRGAN restoration -> MMRealSRGAN + RealESRGAN ensemble (deep multi-view inference)"
        }
    }
